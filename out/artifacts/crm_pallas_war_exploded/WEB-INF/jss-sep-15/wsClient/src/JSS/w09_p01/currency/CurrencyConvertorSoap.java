...
public interface CurrencyConvertorSoap {
    ...
    @RequestWrapper(localName = "ConversionRate", targetNamespace = "http://www.webserviceX.NET/", className = "JSS.w09_p01.currency.ConversionRate")
    @ResponseWrapper(localName = "ConversionRateResponse", targetNamespace = "http://www.webserviceX.NET/", className = "JSS.w09_p01.currency.ConversionRateResponse")
    ...
    public double conversionRate(
        ...
        JSS.w09_p01.currency.Currency fromCurrency,
        @WebParam(name = "ToCurrency", targetNamespace = "http://www.webserviceX.NET/")
        JSS.w09_p01.currency.Currency toCurrency
    );
}
