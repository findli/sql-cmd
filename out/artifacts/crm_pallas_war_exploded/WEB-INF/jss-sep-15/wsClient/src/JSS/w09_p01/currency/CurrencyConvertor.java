 ...
 * 2015-12-16T21:09:00.618+02:00
 * Generated source version: 3.1.1
 * 
 */
@WebServiceClient(name = "CurrencyConvertor", 
                  wsdlLocation = "file:/D:/IdeaProjects/JSS-15-09/wsClient/src/JSS/w09_p01/currency/currencyconvertor.asmx",
...
public class CurrencyConvertor extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/IdeaProjects/JSS-15-09/wsClient/src/JSS/w09_p01/currency/currencyconvertor.asmx");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CurrencyConvertor.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/IdeaProjects/JSS-15-09/wsClient/src/JSS/w09_p01/currency/currencyconvertor.asmx");
        }
        WSDL_LOCATION = url;
    }
