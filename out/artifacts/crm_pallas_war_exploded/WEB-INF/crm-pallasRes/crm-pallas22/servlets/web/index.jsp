          ...
          <div class="forms--users">
            <div class="wrapper__users">
              ...
              <div id="fu2" class="users__panel">
                ...
                <a href="#">Undock</a>
                <input class="users__panel--input" id='cbfu2' type="checkbox">
              </div>
              <div class="users__panel--body">
                <p>Position</p>
                <p>Email</p>
                ...
                <input class="text" id='formPhonefu2' type="text" name="formPhone" placeholder="Number">
                <p>Skype</p>
              </div>
              ...
              <div id="fu3" class="users__panel">
                ...
                <a href="#" class="users__panel--edit">Edit</a>
                <a href="#">Undock</a>
                <input class="users__panel--input" id='cbfu3' type="checkbox">
              </div>
              <div class="users__panel--body">
                <p>Position</p>
                <p>Email</p>
                ...
                <input class="text" id='formPhonefu3' type="text" name="formPhone" placeholder="Number">
                <p>Skype</p>
              </div>
              <div id="fu4" class="users__panel">
                ...
                <a href="#" class="users__panel--edit">Edit</a>
                <a href="#">Undock</a>
                <input class="users__panel--input" id='cbfu4' type="checkbox">
              </div>
              <div class="users__panel--body">
                <p>Position</p>
                <p>Email</p>
                ...
                <input class="text" id='formPhonefu4' type="text" name="formPhone" placeholder="Number">
                <p>Skype</p>
              </div>
              <div id="fu5" class="users__panel">
                ...
                <a href="#" class="users__panel--edit">Edit</a>
                <a href="#">Undock</a>
                <input class="users__panel--input" id='cbfu5' type="checkbox">
              </div>
              <div class="users__panel--body">
                <p>Position</p>
                <p>Email</p>
                ...
                <input class="text" id='formPhonefu5' type="text" name="formPhone" placeholder="Number">
                <p>Skype</p>
              </div>
              <!--END-->
            </div>
