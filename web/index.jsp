          ...
          <div class="forms--users">
            ...
            <div class="wrapper__users">
              <div id="fu1" class="users__panel">
                ...
                <a href="#">Edit</a>
                <a href="#">Undock</a>
                <input class="users__panel--input" id='cbfu${idUser.id}' type="checkbox">         <%--Correct--%>
              </div>
              <div class="users__panel--body">
                <p>Position <c:out value="${idUser.position}"/></p>                             <%--Correct--%>
                <p>Email <c:out value="${idUser.email}"/></p>                                   <%--Correct--%>
                <select>
                  <option>Work telephone</option>
                  <option>Mobile telephone</option>
                  <option>Home telephone</option>
                ...
                <p>Skype <c:out value="${idUser.skype}"/></p>                                                                     <%--Correct--%>
              </div>
