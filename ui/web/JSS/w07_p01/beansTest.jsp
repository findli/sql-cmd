...
${dateValue.time}
<br>
Session creation time = <fmt:formatDate value="${dateValue}" pattern="dd/MM/yyyy HH:mm:ss"/>
<br>
<jsp:setProperty name="dateValue" property="time" value="${pageContext.session.lastAccessedTime}"/>
Session last access time = <fmt:formatDate value="${dateValue}" pattern="dd/MM/yyyy HH:mm:ss"/>
<br>
...
${calc.a} ${calc.operation} ${calc.b} = ${calc.result}
<br>
${calc.reset()}
${calc.result}
<br>
